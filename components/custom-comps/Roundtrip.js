...
import { deleteflightResults } from "../../redux/actions/flightActions";
...
const Roundtrip = ({ airports }) => {
  ...
  const onClickRoundTrip = () => {
    ...
    if (requiredFieldsTestVariable) {
      ...
      flightSearchForm
        .validateFields()
        .then(async () => {
          // delete former flight results in redux store
          dispatch(deleteflightResults());
          ...
          await fetchFlightResults(flightSearchForm.getFieldsValue())
            .then((response) => {
              ...
              // console.log("Caught Resp:", response);
              router.push(
                "/flight-match?flightRequestId=" + response.requestId
              );
              // }
            })
            .catch((error) => {
  ...
  const [departureDefaultDateState, setDepartureDefaultDateState] = useState(
    moment()
  );
  const [returningDefaultDateState, setReturningDefaultDateState] = useState(
    moment().add(1, "days")
  );
  ...
  function disabledDate(current) {
    // Can not select 12 hours before today
    return current && current < moment().subtract(12, "hours");
  }
  ...
  function departureDefaultDate() {
    return moment().add(12, "hours");
  }

  function returningDefaultDate() {
    return moment().add(12, "hours");
  }
              ...
              <div className="col-md-6 col-lg-3">
                ...
                >
                  ...
                  <div className="flight-booking-index">
                    ...
                    >
                      <Input tabIndex={1} name="originLocationCityCode" />
                    </FormAnt.Item>
                  ...
                  <div className="flight-booking-index">
                    ...
                    <FormAnt.Item name="selectedDepartureDate">
                      <DatePicker
                        ...
                        defaultValue={departureDefaultDateState}
                        format={"D MMM YYYY"}
                        onChange={() => {
                          setReturningDateState(
                            moment(
                  ...
                  <div className="flight-booking-index">
                    ...
                    <FormAnt.Item name="selectedReturningDate">
                      <DatePicker
                        ...
                        defaultValue={returningDefaultDateState}
                        // disabledDate={disabledDate}
                        format={"D MMM YYYY"}
                        onChange={() => {
                          setDepartureDefaultDateState(
                            departureDefaultDateState
                          );
                          flightSearchForm.setFieldsValue({
