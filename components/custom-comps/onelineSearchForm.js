          ...
          <div className="flightsearch-section-new">
            <div className="container">
              <div className="row">
                ...
                <div className="col-md-6 col-lg-2">
                  <div className="select-inputField border-left">
                    <Button className="invert-btn" onClick={pickNumofTravelernClass}><Image className="invert-arrow" src={arrowIcon} alt="arrow-image" /></Button>
                  </div>
                </div>
                {/* Button */}
