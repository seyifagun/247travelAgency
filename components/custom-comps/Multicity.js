...
const Multicity = ({ airports }) => {
  ...
  // *****Toggle customdropdown ***** //
  const [showTravelClassAndNumber, setShowTravelClassAndNumber] = useState(false);

  const pickNumberOfTravelerAndClass = () => {
    setShowTravelClassAndNumber(!showTravelClassAndNumber);
  };

  const showPicker = (showTravelClassAndNumber ? <CustomDropdown /> : <></>)
              ...
              <div className="flightdestination-div">
                <div className="container">
                  ...
                  <div className="row">
                    ...
                    {/* Custom Dropdown */}
                    <div className="col-md-6 col-lg-3">
                      <div className="flight mt-3 mb-5" style={{ position: "relative" }} onClick={pickNumberOfTravelerAndClass}>
                        <div className="roundtrip-label">Travelers/Class Type</div>
                        <div className="flight-booking-index">
                          <div className="flight-booking-icon">
                            <Image src={flightClass} alt={"flight-to-icon"} />
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        >
                          ...
                          <div className="flight-booking-index">
                            ...
                            <FormAnt.Item
                              {...restField}
                              hidden={true}
                              name={[name, "originLocationCityCode"]}
                              rules={[
                                {
                                  required: true,
                                  message: "Please Enter Departing City!",
                        ...
                        >
                          ...
                          <div className="flight-booking-index">
                            ...
                            <FormAnt.Item
                              {...restField}
                              hidden={true}
                              name={[name, "originDestinationCityCode"]}
                            >
                              <Input name="originDestinationCityCode" />
                            </FormAnt.Item>
                            ...
                            >
                              <Input
                                ...
                                onBlur={(e) => {
                                  if (
                                    destinationInput.current.state.value !==
                                    null
                                  ) {
                                    // console.log(
                                    //   originDestinationInput.current.state.value
                      ...
                      <div className="col-md-6 col-lg-3">
                        <div className="flight mt-3 mb-5">
                          ...
                          <div className="flight-booking-index">
                            ...
                            <FormAnt.Item
                              name={[name, "selectedDepartureDate"]}
                            >
                              <DatePicker
                                placeholder="Departing"
                                superNextIcon={null}
